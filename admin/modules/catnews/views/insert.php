...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
 ...
 <?php for ($i=0; $i<count($this->keyLangList); $i++):?>
   	<tr>
      <td valign="top" nowrap="nowrap"  class="content-head" style="padding-left:50px;" >Title (<font color="#FF0000"><?php echo $this->keyLangList[$i];?></font>):</td>
	  <td width="77%" colspan="1" align="left"  valign="bottom" class="content-rows"><input type="text" size="60" maxlength="50" id="<?php echo $this->field_NAME[$i];?>" name="<?php echo $this->field_NAME[$i];?>" value="<?php IO::writeData($this->field_NAME[$i]);?>" style="height:18px;"/><?php ERROR::writeError($this->field_NAME[$i], '');?></td>
   </tr>
   <?php endfor;?>
