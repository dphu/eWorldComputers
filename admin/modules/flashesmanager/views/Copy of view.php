...
<script type="text/javascript">
	...
	var isPopup = <?php echo $this->isPopup ? '1': '0';?>;
		...
		for (row=0; row < rows; row++)
		{
			...
			for (column=0; column < columns; column++)
			{
				...
				if (i < itemsCount)
				{
					...
					list[i] = null;
					file = a[0];
					name = SHOW_FILENAME ? '<br>'+a[0] : '';
					dimension = a[1];
					style = a[2];
					a = null;
					src = '<?php echo FOLDER;?>'+file;
					onClick = !isPopup ? 'onClick="javascript:window.open(\''+src+'\');"' : 'onClick="javascript:setSelect(\'<?php echo FOLDER;?>\', \''+file+'\');"';
					td = '<img title="'+file+'" src="'+src+'" '+onClick+' onMouseOver="this.style.border=\'#0000CC solid 2px\'" onMouseOut="this.style.border=\'#FFFFFF solid 2px\'" style="cursor:pointer; border: #FFFFFF solid 2px; '+style+';" />'+name+'<br>('+dimension+')<br><a href="javascript:void(0);" onclick="javascript:deletefile(\''+file+'\', \'td_'+i+'\');">delete</a><br>&nbsp;';
					totalItems++;
				}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="27%" height="50" align="left" valign="middle" nowrap><span class="asadsadsdsadsadsadsadsadsads">&nbsp;&nbsp;&nbsp;<u>IMAGES MANAGER</u> (<font color="#000099">total: </font><font id="totalItems" color="#000099">0</font>)</span></td>
    <td width="64%" align="left" valign="middle" nowrap><form method="post" action="" enctype="multipart/form-data">
      <span class="style1">New Image: 
...
<div style="width:100%; height:300px; display:table;" id="list"></div>
