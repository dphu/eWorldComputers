...
***********************************************************************/
Menu1=new Array("product_1","http://caigido/product_1.html","",2,20,153);
Menu1_1=new Array("product_1_1","http://caigido/product_1_1.html","",0,20,80);
Menu1_2=new Array("product_1_2","http://caigido/product_1_2.html","",3,20,0);
Menu1_2_1=new Array("product_1_2_1","http://caigido/product_2_1_1.html","",0,20,80);
Menu1_2_2=new Array("product_1_2_2","http://caigido/product_1_2_2.html","",0,20,0);
Menu1_2_3=new Array("product_1_2_3","http://caigido/product_1_2_3.html","",0,20,80);

Menu2=new Array("product_2","http://caigido/product_2.html","",2,0,80);
Menu2_1=new Array("product_2_1","http://caigido/product_2_1.html","",0,20,80);
Menu2_2=new Array("product_2_2","http://caigido/product_2_2.html","",0,20,0);

Menu3=new Array("product_3","http://caigido/product_3.html","",0,0,80);


var NoOffFirstLineMenus=3;	// Number of first level items
var LowBgColor='2792BD';		// Background color when mouse is not over
var LowSubBgColor='2792BD';	// Background color when mouse is not over on subs
var HighBgColor='2792BD';	// Background color when mouse is over
var HighSubBgColor='2792BD';	// Background color when mouse is over on subs
...
function KeepPos(){
    ...
    if(TS!=StaticPos){
        var FCStyle=Nav4?FrstCntnr:FrstCntnr.style;
        FCStyle.top=FrstCntnr.OrgTop=StartTop+TS;
        StaticPos=TS
        }
    }
