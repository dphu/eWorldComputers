...
$Config['UserFilesPath'] = 'attachment/';

//MY~ EDIT FCK
$indexfile = 'clients\\javascript\\fckeditor\\editor\\filemanager\\browser\\default\\connectors\\php\\config.php';
$path = __FILE__;
$UserFilesAbsolutePath = str_replace($indexfile, '', $path);
$UserFilesAbsolutePath .= 'attachment\\';
