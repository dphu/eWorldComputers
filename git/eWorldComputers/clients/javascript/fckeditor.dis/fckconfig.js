...
FCKConfig.ToolbarSets["Default"] = [
	['Source', 'Preview','-','Cut','Copy','Paste','PasteText','PasteWord','-','Print','-','Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
    ['Link','Unlink'],['Image','Flash','Table','Rule','SpecialChar','PageBreak'],
    ['TextColor','BGColor'],['FitWindow'],
	'/',
	['FontFormat','FontName','FontSize','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList','UnorderedList','-','Outdent','Indent']
] ;
*/

FCKConfig.ToolbarSets["Default"] = [
    ['Source', 'Preview','-','Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo'],
    ['Link','Unlink'],['Image','Flash','Table','Rule','SpecialChar'],
    ['TextColor','BGColor'],['FitWindow'],
    '/',
    ['FontFormat','FontName','FontSize','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList','UnorderedList','-','Outdent','Indent']
    ] ;
...
FCKConfig.ToolbarSets["Basic"] = [
    ['Cut','Copy','Paste'],
    ['Bold','Underline','Italic','StrikeThrough','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Link','Unlink','-']
    ] ;
