...
$indexfile = 'clients/javascript/fckeditor/editor/filemanager/upload/php/upload.php';
$root = str_replace($indexfile, '', $_SERVER["SCRIPT_NAME"]);
if (substr($root, 0, 1) == '/') {
    $root = substr($root, 1);
}
...
if ($root == '/')
    $root = '';
$Config['UserFilesPath'] = '/' . $root . 'attachment/image/';
