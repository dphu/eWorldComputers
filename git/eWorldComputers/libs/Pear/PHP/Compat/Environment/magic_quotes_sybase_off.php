...
// $Id: magic_quotes_sybase_off.php,v 1.3 2007/05/07 12:28:58 arpad Exp $
    ...
    if (!$allWorks && $magicOn) {
        ...
        while (list($k, $v) = each($inputs)) {
            foreach ($v as $var => $value) {
                ...
                $order1 = $k < $inputCount;
                $stripKeys = $magicOn ? ($isArray ? !$allWorks && !$order1 : $order1 && !$phpLt50 || !$phpLt434) : !$phpLt50 && $phpLt51 && !$isArray;
                if ($stripKeys) {
